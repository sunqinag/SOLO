...
import numpy as np
from diabetic_package.model_training.estimator.segmentation.base_segmentation_estimator import BaseSegmentationEstimator
from collections import OrderedDict
import json


class UnetEstimator(BaseSegmentationEstimator):
    def __init__(self,
                 # 像素类别数
                 channel=3,
                 class_num=3,
                 ...
                 # 卷积特征提取层
                 feature_conv_filter_nums=(16, 32, 64, 128),
