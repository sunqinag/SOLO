...
char2id={'0':0,'1':1,'2':2,'3':3
         }

if __name__ == '__main__':
    from private_tools.imgFileOpterator import Img_processing
    img_path= '水平图3.11/img_bmp/'
    anno_path= '水平图3.11/label/'
    imagelist=os.listdir(img_path)
    label_save_path= '水平图3.11/label_npy/'
    ...
    Img_processing().NpyToTxt(label_save_path, '水平图3.11/label_txt')
