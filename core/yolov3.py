...
if __name__ == '__main__':
    image_path = r'E:\Pycharm_project\tensorflow-yolov3\1.jpg'
    decode_image = tf.image.decode_jpeg(image_path, channels=3)
    decode_image = tf.expand_dims(decode_image, 0)
    decode_image = tf.image.resize_nearest_neighbor(decode_image, (416, 416))
