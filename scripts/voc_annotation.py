...
def convert_voc_annotation(data_path, data_type, anno_path, use_difficult_bbox=True):
    ...
    classes = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus',
               ...
               'train', 'tvmonitor']
    img_inds_file = data_path+'/ImageSets'+'/Main/'+data_type + '.txt'
...
if __name__ == '__main__':
    ...
    # parser.add_argument("--data_path", default=r"D:/GitHub/tensorflow-yolov3/VOC")
    # parser.add_argument("--train_annotation", default=r"data/dataset/voc_train.txt")
    # parser.add_argument("--test_annotation",  default=r"data/dataset/voc_test.txt")
    ...
    # print('=> The number of image for train is: %d\tThe number of image for test is:%d' % (num2, num3))

    data_path = r'../VOC'
    train_annotation = '../data/dataset/voc_train.txt'
    test_annotation = '../data/dataset/voc_test.txt'
    num2 = convert_voc_annotation(data_path+'/train/VOCdevkit/VOC2012', 'trainval', train_annotation, False)
    num3 = convert_voc_annotation(data_path+'/test/VOCdevkit/VOC2007',  'test', test_annotation, False)
    print('=> The number of image for train is: %d\tThe number of image for test is:%d' % (num2, num3))